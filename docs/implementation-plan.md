...
| 2.1.15.11 | Permiso `org:properties:assign` | Agregar a owner/admin en tabla `role_permissions`. Agent no puede transferir. Verificable via `authorize('assign', 'properties')`. | ⬜ |
